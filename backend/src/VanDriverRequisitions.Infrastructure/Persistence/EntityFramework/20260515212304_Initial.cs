        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FeRequisitions_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FeRequisitions_VanDrivers_VanDriverId",
                        column: x => x.VanDriverId,
                        principalTable: "VanDrivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FeAdditionalCosts_FeReasons_ReasonId",
                        column: x => x.ReasonId,
                        principalTable: "FeReasons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FeGeneralTasks_FeTaskTypes_FeTaskTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeRequisitions_VanDriverId",
                table: "FeRequisitions",
                column: "VanDriverId");

...
public sealed class RejectFeRequisitionDtoValidatorTests
{
    private readonly RejectFeRequisitionDtoValidator _validator = new();
    ...
    {
        // Arrange
        var dto = new RejectFeRequisitionDto
        {
            RowVersion = [1, 2, 3],

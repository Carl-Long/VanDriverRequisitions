...
public sealed class UpdateRequisitionLimitRuleValidatorTests
{
    private static readonly Guid FeTaskTypeId = new("11111111-1111-1111-1111-111111111111");

    private readonly UpdateRequisitionLimitRuleDtoValidator _validator = new();
    ...
    public static TheoryData<decimal> InvalidMaxRates => [0m, 0.001m, -0.01m];
    ...
    {
        // Arrange
        var dto = CreateDto(category: RequisitionRowCategory.GeneralTask, fascia: Fascia.Fe, feTaskTypeId: FeTaskTypeId);
    ...
    {
        // Arrange
        var dto = CreateDto(category: RequisitionRowCategory.GeneralTask, fascia: Fascia.Fe, feTaskTypeId: null);
    ...
    {
        // Arrange
        var dto = CreateDto(category: category, fascia: fascia, feTaskTypeId: FeTaskTypeId);
    ...
    private static UpdateRequisitionLimitRuleDto CreateDto(
        RequisitionRowCategory category,
        Fascia fascia,
        Guid? feTaskTypeId,
        int maxQuantity = 30,
    ...
    {
        return new UpdateRequisitionLimitRuleDto
        {
            Category = category,
            Fascia = fascia,
            FeTaskTypeId = feTaskTypeId,

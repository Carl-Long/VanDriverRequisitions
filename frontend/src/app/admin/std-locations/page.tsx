...
export default function StdLocationsPage() {
    ...
    return (
        <PageContainer>
            ...
            <Surface className="mb-6 space-y-4 p-4">
                <div className="grid gap-4 lg:grid-cols-[1.4fr_1fr_1fr_auto] lg:items-end">
                    <SearchInput
                        value={search}
                        onChange={setSearch}
                        placeholder="Search location, postcode, shop, or collection type..."
                    />
                    ...
                    <div className="flex items-center justify-end gap-3 rounded-xl border border-border bg-surface-elevated px-4 py-2">
                        ...
                        <Toggle
                            ...
                            onChange={() => setIncludeInactive((x) => !x)}

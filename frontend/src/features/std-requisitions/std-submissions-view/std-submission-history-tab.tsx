...
type Props = {
    submissions: StdRequisitionSubmissionHistory[];
    returnTo?: string;
};

export function StdSubmissionHistoryTab({ submissions, returnTo }: Readonly<Props>) {
...
type SubmissionCardProps = {
    submission: StdRequisitionSubmissionHistory;
    returnTo?: string;
};
...
function getSubmissionHref(submissionId: string, returnTo?: string) {
    ...
    return `/standard-van-drivers/submissions/${submissionId}${query ? `?${query}` : ""}`;
}
